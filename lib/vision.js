...
fs.readFile('client_secret.json', function processClientSecrets(err, content) {
  ...
  // Drive API.
    authorize(JSON.parse(content), uploadFilesReadStream);
});
...
// send single request
var pVision = vision.annotate(req).then((res) => {
  // handling response
  //console.log(JSON.stringify(res.responses));
  var myReadStream = JSON.stringify(res.responses);
  console.log("========================================================================");
  return myReadStream;
}, (e) => {
  console.log('Error: ', e)
...
function uploadFilesReadStream(auth, pVision) {
